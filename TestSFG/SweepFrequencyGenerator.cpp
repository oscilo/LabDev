...
SweepFrequencyGenerator::~SweepFrequencyGenerator()
{
	delete back;
	delete lamp;
	delete d[0];
...
void SweepFrequencyGenerator::initProperties()
{
	//*
	set_new_fst(fmin);
	set_new_fen(fmax);
...
void SweepFrequencyGenerator::paintEvent(QPaintEvent *event)
{
...
void SweepFrequencyGenerator::mousePressEvent(QMouseEvent *event)
{
	QSize curSize = back->size();
...
void SweepFrequencyGenerator::set_new_fst(int new_val)
{
	fst = new_val;
...
void SweepFrequencyGenerator::set_new_fen(int new_val)
{
	fen = new_val;
...
void SweepFrequencyGenerator::set_new_mark1(int new_val)
{
	mark1 = new_val;
...
void SweepFrequencyGenerator::set_new_mark2(int new_val)
{
	mark2 = new_val;
